...
} from '../../../../../cast-member/infra/repository/sequelize/cast-member-sequelize';
...
import { CategorySequelizeRepository } from '../../../../../category/infra/repository/sequelize/category-sequelize.repository';
...
import { GenreModel } from '../../../../../genre/infra/repository/sequelize/genre-model';
import { GenreSequelizeRepository } from '../../../../../genre/infra/repository/sequelize/genre-sequelize.repository';
import { UnitOfWorkSequelize } from '../../../../../shared/infra/repository/sequelize/unit-of-work-sequelize';
import { RatingValues } from '../../../../domain/rating.vo';
import { Video, VideoId } from '../../../../domain/video.aggregate';
import { setupSequelizeForVideo } from '../../../../infra/repository/sequelize/testing/helpers';
import { VideoSequelizeRepository } from '../../../../infra/repository/sequelize/video-sequelize.repository';
import { VideoModel } from '../../../../infra/repository/sequelize/video.model';
...
describe('CreateVideoUseCase Integration Tests', () => {
  ...
  it('should create a video', async () => {
    ...
    genres[0].syncCategoriesIds([categories[0].category_id]);
    genres[1].syncCategoriesIds([categories[1].category_id]);
