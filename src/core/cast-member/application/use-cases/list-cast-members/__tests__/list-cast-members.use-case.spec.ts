import { CastMemberInMemoryRepository } from 'core/cast-member/infra/repository/in-memory/cast-member-in-memory.repository';
...
describe('ListCastMembersUseCase Unit Tests', () => {
  ...
  test('toOutput method', () => {
    ...
    expect(output).toStrictEqual({
      items: [entity].map((i) => CastMemberOutputMapper.toOutput(i)),
      total: 1,
      current_page: 1,
      per_page: 2,
      last_page: 1,
  ...
  it('should search sorted by created_at when input param is empty', async () => {
    ...
    expect(output).toStrictEqual({
      items: [...items]
        .reverse()
        .map((i) => CastMemberOutputMapper.toOutput(i)),
      total: 2,
      current_page: 1,
      per_page: 15,
      last_page: 1,
  ...
  it('should search applying paginate and filter by name', async () => {
    ...
    expect(output).toStrictEqual({
      items: [castMembers[0], castMembers[2]].map((i) =>
        CastMemberOutputMapper.toOutput(i),
      ),
      total: 3,
      current_page: 1,
      per_page: 2,
    ...
    expect(output).toStrictEqual({
      items: [castMembers[3]].map((i) => CastMemberOutputMapper.toOutput(i)),
      total: 3,
      current_page: 2,
      per_page: 2,
      last_page: 2,
    ...
    const arrange = [
      {
        ...
        output: {
          items: [castMembers[0], castMembers[1]].map((i) =>
            CastMemberOutputMapper.toOutput(i),
          ),
          total: 3,
          current_page: 1,
      ...
      },
      {
        ...
        output: {
          items: [castMembers[3], castMembers[4]].map((i) =>
            CastMemberOutputMapper.toOutput(i),
          ),
          total: 3,
          current_page: 1,
    ...
    const arrange = [
      {
        ...
        output: {
          items: [castMembers[1], castMembers[0]].map((i) =>
            CastMemberOutputMapper.toOutput(i),
          ),
          total: 5,
          current_page: 1,
      ...
      },
      {
        ...
        output: {
          items: [castMembers[4], castMembers[2]].map((i) =>
            CastMemberOutputMapper.toOutput(i),
          ),
          total: 5,
          current_page: 2,
      ...
      },
      {
        ...
        output: {
          items: [castMembers[3], castMembers[2]].map((i) =>
            CastMemberOutputMapper.toOutput(i),
          ),
          total: 5,
          current_page: 1,
      ...
      },
      {
        ...
        output: {
          items: [castMembers[4], castMembers[0]].map((i) =>
            CastMemberOutputMapper.toOutput(i),
          ),
          total: 5,
          current_page: 2,
    ...
    const arrange = [
      {
        ...
        output: {
          items: [castMembers[2], castMembers[4]].map((i) =>
            CastMemberOutputMapper.toOutput(i),
          ),
          total: 3,
          current_page: 1,
  ...
  describe('should search applying filter by type, sort and paginate', () => {
    ...
    const arrange = [
      ...
      },
      {
        ...
        output: {
          items: [castMembers[1], castMembers[5]].map((i) =>
            CastMemberOutputMapper.toOutput(i),
          ),
          total: 3,
          current_page: 1,
  ...
  it('should search using filter by name and type, sort and paginate', async () => {
    ...
    expect(output).toStrictEqual({
      items: [castMembers[0]].map((i) => CastMemberOutputMapper.toOutput(i)),
      total: 3,
      current_page: 2,
      per_page: 2,
      last_page: 2,
